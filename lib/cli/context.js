...
function getGlobalPackagesDir() {
  if (isPathInside(__dirname, globalDirs.yarn.packages)) return globalDirs.yarn.packages;
  if (isPathInside(__dirname, globalDirs.npm.packages)) return globalDirs.npm.packages;
  return undefined;
}
