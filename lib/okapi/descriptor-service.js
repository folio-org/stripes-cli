...
import generateModuleDescriptor from '../cli/generate-module-descriptor.js';
import { moduleDescriptorExtras, backendDescriptorExtras, toFolioName } from '../environment/inventory.js';
...
export default class DescriptorService {
  ...
  getUiPlatformModuleDescriptors(isStrict) {
    ...
    _.uniq(moduleNames.concat(extraModuleNames)).forEach(moduleName => {
