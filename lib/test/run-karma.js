...
function generateKarmaConfig(webpackConfig, karmaOptions) {
...
function runKarmaTests(webpackConfig, karmaOptions) {
  const karmaConfig = generateKarmaConfig(webpackConfig, karmaOptions);
