import WebpackBundleAnalyzer from 'webpack-bundle-analyzer'; // ).BundleAnalyzerPlugin; // eslint-disable-line
...
import { okapiOptions, stripesConfigFile, stripesConfigStdin, stripesConfigOptions, buildOptions } from './common-options.js';
...
const { processError, processStats, emitLintWarnings, limitChunks, ignoreCache } = { webpackCommon };
