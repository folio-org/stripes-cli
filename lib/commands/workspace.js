...
const { allModules, allModulesAsFlatArray } = importLazy('../environment/inventory');
...
module.exports = {
  command: 'workspace',
  describe: 'Create a workspace for Stripes development, select modules, clone, and install.',
  builder: (yargs) => {
