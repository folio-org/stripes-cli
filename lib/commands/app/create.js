  ...
  return createApp.createApp(argv.name, argv.desc)
    ...
    .then((result) => {
      if (result.isInstalled) {
        ...
        console.log(`Install dependencies, "cd ${appData.appDir}", and then "stripes serve" to run your new app`);
      } else {
        console.log(`"cd ${appData.appDir}", install dependencies, and then "stripes serve" to run your new app`);
      }
      return Promise.resolve();
    })
    .then(() => {
