...
const { okapiRequired, tenantRequired, stripesConfigFile, stripesConfigStdin } = importLazy('../common-options');
...
module.exports = {
  ...
  builder: (yargs) => {
    yargs
      ...
      .options({ ...okapiRequired, ...tenantRequired, ...stripesConfigStdin })
