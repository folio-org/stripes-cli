...
const { applyOptions, okapiRequired, tenantRequired, stripesConfigInput } = importLazy('../common-options');
...
module.exports = {
  ...
  builder: (yargs) => {
    ...
    return applyOptions(yargs, Object.assign({}, okapiRequired, tenantRequired, stripesConfigInput));
  },
