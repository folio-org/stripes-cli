...
const DevelopmentEnvironment = importLazy('../../environment/development-environment');
...
module.exports = {
  ...
  builder: (yargs) => {
    ...
    yargs
      .example('$0 create-dev', 'Create a dev platform in a new "stripes" directory with a Yarn workspace.')
      .example('$0 create-dev example', 'Create a dev platform in a new "example" directory')
      .example('$0 create-dev --no-workspace', 'Create a dev platform without a Yarn workspace.')
      .example('$0 create-dev --modules all', 'Create a dev platform with all available modules')
      .example('$0 create-dev --modules ui-users stripes-components', 'Create a dev platform with just ui-users stripes-components')
      .example('$0 create-dev --no-install', 'Create a dev platform without a installing dependencies.');
    return yargs;
  },
