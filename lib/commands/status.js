...
const { applyOptions, okapiOptions, stripesConfigInput, stripesConfigOptions } = importLazy('./common-options');
...
module.exports = {
  ...
  builder: (yargs) => {
    ...
    return applyOptions(yargs, Object.assign({}, okapiOptions, stripesConfigInput, stripesConfigOptions));
  },
