...
module.exports = {
  ...
  builder: (yargs) => {
    yargs
      ...
      .option('watch', { type: 'boolean', describe: 'Watch test files for changes and run tests automatically when changes are saved.', alias: 'karma.watch' })
      .option('cache', { type: 'boolean', describe: 'Enable caching of test bundle. Defaults to false.', alias: 'karma.cache' })
