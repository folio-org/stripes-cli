...
const serveBuildOptions = { ...buildOptions };
...
function serveCommand(argv) {
  ...
  stripes.api.serve(platform.getStripesConfig(), { ...argv, webpackOverrides })
    .catch(processError);
}
...
module.exports = {
  ...
  builder: (yargs) => {
    yargs
      ...
      .options({ ...serverOptions, ...okapiOptions, ...stripesConfigStdin, ...stripesConfigOptions, ...serveBuildOptions })
