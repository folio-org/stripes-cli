...
const { applyOptions, serverOptions, okapiOptions, stripesConfigInput, stripesConfigOptions, buildOptions } = importLazy('./common-options');
...
module.exports = {
  ...
  builder: (yargs) => {
    ...
    return applyOptions(yargs, Object.assign({}, serverOptions, okapiOptions, stripesConfigInput, stripesConfigOptions, buildOptions));
  },
