...
function serveCommand(argv) {
  ...
  // TODO: Standardize the beforeBuild hook and apply to all build related commands
  if (argv.beforeBuild && typeof argv.beforeBuild === 'function') {
    webpackOverrides.push(argv.beforeBuild);
  }
